...
def gradient_check(x, theta, epsilon = 1e-7):
    ...
    ### START CODE HERE ### (approx. 1 line)
    numerator = np.abs(grad - gradapprox)                               # Step 1'
    denominator = np.abs(grad) + np.abs(gradapprox)                             # Step 2'
...
#         print(thetaplus)
    ...
    ### START CODE HERE ### (approx. 1 line)
    numerator = np.sqrt(np.sum(np.square(grad - gradapprox)))                                           # Step 1'
    denominator = np.sqrt(np.sum(np.square(grad))) + np.sqrt(np.sum(np.square(gradapprox)))                                         # Step 2'
    difference = numerator / denominator                                          # Step 3'
    ### END CODE HERE ###
