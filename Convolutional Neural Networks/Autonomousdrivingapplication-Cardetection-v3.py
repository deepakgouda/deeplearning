...
def predict(sess, image_file):
    ...
    ### START CODE HERE ### (≈ 1 line)
#     out_scores, out_boxes, out_classes = sess.run(yolo_eval(yolo_head(yolo_model(yolo_model.input), anchors, len(class_names))), feed_dict={yolo_model.input:image_data, K.learning_phase():0})
